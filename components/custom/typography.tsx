...
const typographyVariants = cva("", {
  variants: {
    variant: {
      h1: "scroll-m-20 text-2xl font-bold tracking-tight sm:text-3xl md:text-4xl lg:text-5xl",
      h1Muted:
        "scroll-m-20 text-2xl font-bold tracking-tight text-muted-foreground sm:text-3xl md:text-4xl lg:text-5xl",
